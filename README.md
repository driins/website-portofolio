...
## Preview
<p align="center">
  <img src="img/Demo1.png" alt="Domain Proyek" width="600"/>
  <img src="img/Demo2.png" alt="Domain Proyek" width="600"/>
</p>
...
1. Clone the repository:
   ```bash
   git clone https://github.com/driins/website-portofolio.git
   ```
2. Open index.html
